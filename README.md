...
1. Open PyCharm and create a new project named **Laurente_ecommerce_app**.
...
4. **Copy the code** from [Laurente_ecommerce_app/app.py](Laurente_ecommerce_app/app.py) and paste it into your local `app.py`.
5. **Run the program**.
...
1. Go to the [Official Postman Website](https://www.postman.com/downloads/?fbclid=IwY2xjawPcFQ9leHRuA2FlbQIxMQBzcnRjBmFwcF9pZAEwAAEeS0S5hlcdbMlB0ZXWUPFHCokklLz7-UDpP-Jyesdgz8upaWc5agdSX-oEMTI_aem_ie0d1P24o4xgvnknuLQU-g) to download the application.
